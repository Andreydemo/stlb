    ...
    <div class="container">
        <div class="check_box">
            <div class="col-md-9 cart-items">
                <h1>My Shopping Bag (${cart.order.productsCount})</h1>
                ...
                <c:forEach items="${cart.order.products}" var="entity">
            ...
            <div class="col-md-3 cart-total">
                ...
                <div class="price-details">
                    <h3>Price Details</h3>
                    <span>Total</span>${cart.order.total}</span>
                    <span>Discount</span>
                ...
                <ul class="total_price">
                    ...
                    <li class="last_price"><span>${cart.order.total}</span></li>
                    <div class="clearfix"> </div>
                </ul>
                <div class="clearfix"></div>
