        ...
        <div class="header_top">
            <div class="header_top_left">
                <div class="box_11"><a href="checkout">
                    <h4><p>Cart: <span class="">$ ${cart.order.total}</span> (<span id="" class="">${cart.order.itemsCount}</span> items)</p><img src="images/bag.png" alt=""/><div class="clearfix"> </div></h4>
                </a></div>
                                ...
                                <div class="view view-first">
                                    <div class="inner_content clearfix">
                                        <div class="product_image">
                                            <div class="mask1"><img src="images/${product.images[0]}" alt="image" class="img-responsive zoom-img"></div>
                                            <div class="mask">
                                            ...
                                            <div class="product_container">
                                                <h4>${product.name}</h4>
                                                <p>Dresses</p>
                                                <div class="price mount item_price">$${product.listPrice}</div>
                                                <%--<a class="button cbp-vm-icon cbp-vm-add" href="#">Add to cart</a>--%>
                                                <form action="" method="post">
                                                    <input type="hidden" value="${product.id}" name="productId"/>
                                                    <input type="hidden" value="1" name="quantity"/>
                                                    <input type="submit" class="button cbp-vm-icon cbp-vm-add" value="Add to cart"/>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
